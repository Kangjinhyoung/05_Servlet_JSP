...
public class ExampleServlet1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 * - 서버 -> 클라이언트로 연결된 출력용 스트림을 제공(PrintWriter)
		 */
		
		// 매개 변수(Parameter)
		
		// String getParameter("name 속성값")
		// -> 요청 시 전달된 데이터를 얻어오겠다는 구문
		// -> 얻어오고 싶은 input의 name 속성값을 작성, HTML에서 읽어온 데이터는 기본적으로 모두 String
		 ...
		 * 2) 클라이언트의 브라우저가 응답 받은 HTML 코드를 해석해 화면을 보여주게 된다
		 */
		
		/* 응답 처리 1. 응답하는 문서의 형식과 문자 인코딩 지정 */
		resp.setContentType("text/html; charset=UTF-8");
		// text / html  : 글자로된 HTML 형식의 문서
